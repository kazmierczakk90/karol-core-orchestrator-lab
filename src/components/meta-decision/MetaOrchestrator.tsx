...
import { Brain, Activity, AlertTriangle, CheckCircle, Clock, Settings, Shield } from 'lucide-react';
      ...
      <Card className="bg-slate-800/50 border-purple-800/30">
        <CardHeader>
          ...
          <CardDescription className="text-slate-300">
            Centralny system zarządzania decyzjami i koordynacji agentów + Level 20+ Safety Protocols
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Tabs defaultValue="decisions" className="w-full">
            <TabsList className="grid w-full grid-cols-2 bg-slate-700/50">
              <TabsTrigger value="decisions">Decision Management</TabsTrigger>
            ...
            <TabsContent value="safety" className="space-y-4">
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-6">
                <div className="bg-slate-700/50 p-4 rounded-lg">
                  <div className="text-green-400 text-2xl font-bold">{stats.safetyScore}%</div>
                  <div className="text-slate-400 text-sm">Safety Score</div>
                </div>
                <div className="bg-slate-700/50 p-4 rounded-lg">
                  <div className="text-green-400 text-2xl font-bold">{stats.threatsDetected}</div>
              ...
              <div className="flex items-center justify-between p-4 bg-slate-700/50 rounded-lg">
                <div>
                  <div className="text-white font-medium">Enhanced Safety Mode</div>
                  <div className="text-slate-400 text-sm">Level 20+ protection protocols active</div>
                </div>
                <Switch
                  checked={safetyMode}
              ...
              <div className="bg-slate-700/50 p-4 rounded-lg">
                <h3 className="text-white font-medium mb-3 flex items-center space-x-2">
                  ...
                  <span>Active Safety Protocols</span>
                </h3>
                <div className="grid grid-cols-2 gap-2 text-sm">
                  <div className="flex items-center space-x-2">
                    <CheckCircle className="h-3 w-3 text-green-400" />
                    <span className="text-slate-300">Reflex Engine</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <CheckCircle className="h-3 w-3 text-green-400" />
                    <span className="text-slate-300">Guardian Core 2.0</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <CheckCircle className="h-3 w-3 text-green-400" />
                    <span className="text-slate-300">Failover Daemon</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <CheckCircle className="h-3 w-3 text-green-400" />
                    <span className="text-slate-300">AutoPulse</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <CheckCircle className="h-3 w-3 text-green-400" />
                    <span className="text-slate-300">Function Inventory</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <CheckCircle className="h-3 w-3 text-green-400" />
                    <span className="text-slate-300">Priority Engine</span>
                  </div>
                </div>
              </div>
            </TabsContent>
